...
type FakeRoutes struct {
	Fake *FakePrefixrouterV1beta1
	ns   string
}

var routesResource = schema.GroupVersionResource{Group: "prefixrouter.app", Version: "v1beta1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "prefixrouter.app", Version: "v1beta1", Kind: "Route"}
